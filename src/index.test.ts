...
describe('aqicalc', function() {
    ...
    it('should be aqi=500, primary=PM2.5 when 10, 10, 10, 10, 10, 10000', () => {
        ...
        expect(ChinaAQICalc(data)).toEqual([{ aqi: 500, pollutant: "PM2.5" }]);
    });
});
